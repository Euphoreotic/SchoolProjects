...
public class TestHierarchy {
	...
	public void test11() throws Exception {
		// size, length, gauge, finish, price/unit, unit size
		CommonNail toAdd = new CommonNail("11D", 3.0, 2, "Hot Dipped Galvanized", 153.29, 550);
		assertNull(toAdd);
	}
	...
	public void test12() throws Exception {
		// size, length, gauge, finish, price/unit, unit size
		CommonNail toAdd = new CommonNail("10D", 1.5, 9.0, "Bright", 21.69, 345);
		assertNull(toAdd);
	}
	...
	public void test13() throws Exception {
		// size, length, gauge, finish, price/unit, unit size
		CommonNail toAdd = new CommonNail("10D", 3.0, 6.0, "Bright", 21.69, 345);
		assertNull(toAdd);
	}
	...
	public void test14() throws Exception {
		// size, length, gauge, finish, price/unit, unit size
		CommonNail toAdd = new CommonNail("10D", 3.0, 6.0, "Plain", 21.69, 345);
		assertNull(toAdd);
	}
